...
def get_data(symbol, kline_size = Client.KLINE_INTERVAL_12HOUR, save = False):

    """Get historical price, volume and market capitalization data by ticker."""
    ## GET HISTORICAL PRICE DATA
    # name of the file containing full data
    filename = f'{symbol}_{kline_size}_full_data.csv'
    ...
    oldest_point, newest_point = minutes_of_new_data(symbol, kline_size, df, source = "binance")
    ...
    if oldest_point == datetime.strptime('1 Jan 2017', '%d %b %Y'): 
        ...
        print(f'Downloading {available_data} instances of {kline_size} new data available for {symbol}, i.e. ')
